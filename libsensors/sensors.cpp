...
{
    {"CM36651 Light Sensor", "Capella Microsystems", 1, SENSORS_LIGHT_HANDLE,
     SENSOR_TYPE_LIGHT, 10240.0f, 1.0f, 0.75f, 0, 0, 0,
     SENSOR_STRING_TYPE_LIGHT, "", 0, SENSOR_FLAG_CONTINUOUS_MODE, { }},
    { "CM36651 Proximity Sensor", "Capella Microsystems", 1, SENSORS_PROXIMITY_HANDLE,
    ...
    {"BMP180 Pressure", "Bosch", 1, SENSORS_PRESSURE_HANDLE,
     SENSOR_TYPE_PRESSURE, 1100.0f, 0.01f, 0.05f, 50000, 0, 0,
    ...
    {"MPL Gyroscope", "Invensense", 1, SENSORS_GYROSCOPE_HANDLE,
     SENSOR_TYPE_GYROSCOPE, GYRO_MPU6050_RANGE, GYRO_MPU6050_RESOLUTION,
     GYRO_MPU6050_POWER, 10000, 0, 0, SENSOR_STRING_TYPE_GYROSCOPE, "",
     0, SENSOR_FLAG_CONTINUOUS_MODE, {}},
    {"MPL Accelerometer", "Invensense", 1, SENSORS_ACCELERATION_HANDLE,
     SENSOR_TYPE_ACCELEROMETER, ACCEL_MPU6050_RANGE, ACCEL_MPU6050_RESOLUTION,
     ACCEL_MPU6050_POWER, 10000, 0, 0, SENSOR_STRING_TYPE_ACCELEROMETER, "",
     0, SENSOR_FLAG_CONTINUOUS_MODE, {}},
    {"MPL Magnetic Field", "Invensense", 1, SENSORS_MAGNETIC_FIELD_HANDLE,
     SENSOR_TYPE_MAGNETIC_FIELD, COMPASS_AKM8975_RANGE, COMPASS_AKM8975_RESOLUTION,
     COMPASS_AKM8975_POWER, 10000, 0, 0, SENSOR_STRING_TYPE_MAGNETIC_FIELD, "",
     0, SENSOR_FLAG_CONTINUOUS_MODE, {}},
